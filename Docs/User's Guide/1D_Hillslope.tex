...
From version 2025.014 those constant-head records in \texttt{Modflow.chd} include both a start head (the cell starting head) and an end head (the assigned value) so \mfus\ can ramp the outlet over the stress period.
Examples \texttt{3\_0\_SWF\_CHD} and \texttt{3\_1\_CLN\_for\_SWF} therefore differ from a 2025.012 baseline; the critical-depth sibling \texttt{3\_SWF} does not.
See Appendix~\ref{appendix:release_verification}.
