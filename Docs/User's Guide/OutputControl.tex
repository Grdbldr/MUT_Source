...
\begin{verbatim}
    # MODFLOW-USG OC file written by Modflow-User-Tools version 2025.023
    ATSA NPTIMES   10
    ...
    DARCY VELOCITY SAVE UNIT   116
    LINEAR VELOCITY SAVE UNIT   117
    PERIOD     1
        DELTAT   1.0000E-03
        TMINAT   1.0000E-05
        TMAXAT    60.00
...
\begin{itemize}
    ...
    \item Darcy and average-linear velocity save units are written for GWF whenever the VEL package is active (always for current \mut\ builds). Analogous binary units for \cln\ and \swf\ are listed in the NAM file when those domains exist. After {\tt mut \_post}, those binaries become Tecplot velocity files; see Section~\ref{section:VelocityVectors} for vector mapping.
