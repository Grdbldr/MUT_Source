...
\begin{verbatim}
    # MODFLOW-USG OC file written by Modflow-User-Tools version 2025.022
    ATSA NPTIMES   10
...
\begin{itemize}
    ...
    \item Darcy and average-linear velocity save units are written for GWF whenever the VEL package is active (always for current \mut\ builds). Analogous binary units for \cln\ and \swf\ are listed in the NAM file when those domains exist.
