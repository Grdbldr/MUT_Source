...
MODULE CLN1MODULE
    ...
    integer(i4), SAVE :: NCLN,ICLNCB,ICLNHD,ICLNDD,ICLNIB, &
        NJA_CLN, NCLNNDS,NCLNGWC,NCONDUITYP,NRECTYP,NGENSHPTYP,NGENTABROWS,ICLNTIB, &   !aq CLN CCF
    ...
    ! General-section tabular geometry (ISHAPE=3)
    real(sp), SAVE, DIMENSION(:,:,:),ALLOCATABLE :: ACLNGEN  ! (4, NGENTABROWS, NGENSHPTYP)
    real(sp), SAVE, DIMENSION(:),ALLOCATABLE :: ACLNGENK
    real(sp), SAVE, DIMENSION(:),ALLOCATABLE :: ACLNGENA
    real(sp), SAVE, DIMENSION(:),ALLOCATABLE :: ACLNGENP
